...
public class ErrorModelTests extends ESTestCase {
    ...
    private record CalibrationFixture(FloatVectorValues fvv, CalibrationQueries queries, int[] corpusOrdinals) {}
    ...
    private static CalibrationFixture newCalibrationFixture(int dim) throws IOException {
        ...
        CalibrationQueries queries = new CalibrationQueries(fvv, queryOrdinals, dim, false, false, null, 8);
        return new CalibrationFixture(fvv, queries, corpusOrdinals);
    }
